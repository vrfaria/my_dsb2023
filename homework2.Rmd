...
mass_shootings %>%
  ...
  geom_text(aes(label = paste0(round(perc_cases*100, 1), "%")),
            position = position_dodge(width = 0.9),
            hjust = 0.5,
            vjust = -0.5,
            colour = "black", 
            size = 3)+
  scale_fill_manual(values = c("green4", "yellow3", "red2")) +
  labs(x = "Gender", 
       y = "Number of Mass Attacks",
       fill = "Prior Signs of Mental Health Issues",
       title = "Mass Shootings by Males with Prior Mental Health Issues represents \n46.5% of the ocurrences since 1982, summing up a total of 67 occurences", 
       subtitle = "Mass Shootings by Gender and Prior Mental Health Issues Status") +
  theme_minimal()
...
mass_shootings %>%
  ...
  labs(y = "Number of Mass Attacks",
       title = "Mass shootings are more often in the months of February, June and November", 
       subtitle = "Mass shootings by month of the year since 1982") +
  theme_minimal()
