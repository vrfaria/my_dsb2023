...
mass_shootings %>%
  ...
  ggplot(aes(y=fatalities, color=race)) +
  geom_boxplot() +
  scale_color_manual(values = c("White" = "grey", "Black" = "black")) +
  labs(subtitle = "Distribution of Fatalities by Race", title = "Mass shootings started by white people usually have more fatalities \nthan those started by black people, including more and higher outliers") +
  theme_minimal() +
  ylim(0, 30) +
  annotate("text", x = Inf, y = Inf, label = "A mass shooting with 58 fatalities was omitted from the 'White' plot for better visualization", hjust = 1.1, vjust = 1.7, size = 2.5)
...
mass_shootings %>%
  ...
  labs(subtitle = "Distribution of Fatalities by Race", title = "The figures don't change by much when comparing White to Latinos") +
  theme_minimal() +
  ylim(0, 30) +
  annotate("text", x = Inf, y = Inf, label = "A mass shooting with 58 fatalities was omitted from the 'White' plot for better visualization", hjust = 1.1, vjust = 1.7, size = 2.5)
